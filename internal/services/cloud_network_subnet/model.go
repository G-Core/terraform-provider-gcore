...
type CloudNetworkSubnetModel struct {
	...
	IPVersion              types.Int64                           `tfsdk:"ip_version" json:"ip_version,optional"`
	...
	GatewayIP              types.String                          `tfsdk:"gateway_ip" json:"gateway_ip,optional"`
	DNSNameservers         *[]types.String                       `tfsdk:"dns_nameservers" json:"dns_nameservers,optional"`
	Tags                   *map[string]types.String              `tfsdk:"tags" json:"tags,optional,no_refresh"`
	HostRoutes             *[]*CloudNetworkSubnetHostRoutesModel `tfsdk:"host_routes" json:"host_routes,optional"`
