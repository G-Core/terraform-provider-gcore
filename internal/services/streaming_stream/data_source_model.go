...
type StreamingStreamDataSourceModel struct {
	ID                  types.Int64                                                              `tfsdk:"id" path:"stream_id,computed"`
	StreamID            types.Int64                                                              `tfsdk:"stream_id" path:"stream_id,optional"`
	...
	HTMLOverlays        customfield.NestedObjectList[StreamingStreamHTMLOverlaysDataSourceModel] `tfsdk:"html_overlays" json:"html_overlays,computed"`
	FindOneBy           *StreamingStreamFindOneByDataSourceModel                                 `tfsdk:"find_one_by"`
}

func (m *StreamingStreamDataSourceModel) toListParams(_ context.Context) (params streaming.StreamListParams, diags diag.Diagnostics) {
	params = streaming.StreamListParams{}

	if !m.FindOneBy.WithBroadcasts.IsNull() {
		params.WithBroadcasts = param.NewOpt(m.FindOneBy.WithBroadcasts.ValueInt64())
	}

	return
}

type StreamingStreamHTMLOverlaysDataSourceModel struct {
...
type StreamingStreamFindOneByDataSourceModel struct {
