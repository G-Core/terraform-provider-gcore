...
var _ datasource.DataSourceWithConfigValidators = (*StreamingStreamsDataSource)(nil)

func ListDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"with_broadcasts": schema.Int64Attribute{
				Description: "Query parameter. Set to 1 to get details of the broadcasts associated with the stream",
				Optional:    true,
			},
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StreamingStreamsItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"html_overlays": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[StreamingStreamsHTMLOverlaysDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.Int64Attribute{
...
func (d *StreamingStreamsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *StreamingStreamsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
