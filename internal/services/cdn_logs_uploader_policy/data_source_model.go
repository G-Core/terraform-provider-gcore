...
type CDNLogsUploaderPolicyDataSourceModel struct {
	...
	FieldConversions        customfield.NestedObjectMap[CDNLogsUploaderPolicyFieldConversionsDataSourceModel] `tfsdk:"field_conversions" json:"field_conversions,computed"`
	FindOneBy               *CDNLogsUploaderPolicyFindOneByDataSourceModel                                    `tfsdk:"find_one_by"`
}

func (m *CDNLogsUploaderPolicyDataSourceModel) toListParams(_ context.Context) (params cdn.LogsUploaderPolicyListParams, diags diag.Diagnostics) {
...
type CDNLogsUploaderPolicyFieldConversionsDataSourceModel struct {
	Conversions customfield.NestedObjectList[CDNLogsUploaderPolicyFieldConversionsConversionsDataSourceModel] `tfsdk:"conversions" json:"conversions,computed"`
}

type CDNLogsUploaderPolicyFieldConversionsConversionsDataSourceModel struct {
	Config customfield.NestedObject[CDNLogsUploaderPolicyFieldConversionsConversionsConfigDataSourceModel] `tfsdk:"config" json:"config,computed"`
	Type   types.String                                                                                    `tfsdk:"type" json:"type,computed"`
}

type CDNLogsUploaderPolicyFieldConversionsConversionsConfigDataSourceModel struct {
	Factor    types.Float64                 `tfsdk:"factor" json:"factor,computed"`
	Precision types.Int64                   `tfsdk:"precision" json:"precision,computed"`
	Rounding  types.String                  `tfsdk:"rounding" json:"rounding,computed"`
	Values    customfield.Map[types.String] `tfsdk:"values" json:"values,computed"`
	Default   types.String                  `tfsdk:"default" json:"default,computed"`
}

type CDNLogsUploaderPolicyFindOneByDataSourceModel struct {
