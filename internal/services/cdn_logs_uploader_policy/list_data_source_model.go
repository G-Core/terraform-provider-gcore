...
type CDNLogsUploaderPoliciesItemsDataSourceModel struct {
	...
	FieldConversions        customfield.NestedObjectMap[CDNLogsUploaderPoliciesFieldConversionsDataSourceModel] `tfsdk:"field_conversions" json:"field_conversions,computed"`
...
type CDNLogsUploaderPoliciesFieldConversionsDataSourceModel struct {
	Conversions customfield.NestedObjectList[CDNLogsUploaderPoliciesFieldConversionsConversionsDataSourceModel] `tfsdk:"conversions" json:"conversions,computed"`
}

type CDNLogsUploaderPoliciesFieldConversionsConversionsDataSourceModel struct {
	Config customfield.NestedObject[CDNLogsUploaderPoliciesFieldConversionsConversionsConfigDataSourceModel] `tfsdk:"config" json:"config,computed"`
	Type   types.String                                                                                      `tfsdk:"type" json:"type,computed"`
}

type CDNLogsUploaderPoliciesFieldConversionsConversionsConfigDataSourceModel struct {
