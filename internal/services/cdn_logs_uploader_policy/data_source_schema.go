	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"field_conversions": schema.MapNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectMapType[CDNLogsUploaderPolicyFieldConversionsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"conversions": schema.ListNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectListType[CDNLogsUploaderPolicyFieldConversionsConversionsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"config": schema.SingleNestedAttribute{
										Computed:   true,
										CustomType: customfield.NewNestedObjectType[CDNLogsUploaderPolicyFieldConversionsConversionsConfigDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
