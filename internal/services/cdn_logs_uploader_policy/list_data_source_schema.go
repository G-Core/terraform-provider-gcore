...
var _ datasource.DataSourceWithConfigValidators = (*CDNLogsUploaderPoliciesDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CDNLogsUploaderPoliciesItemsDataSourceModel](ctx),
...
func (d *CDNLogsUploaderPoliciesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CDNLogsUploaderPoliciesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
