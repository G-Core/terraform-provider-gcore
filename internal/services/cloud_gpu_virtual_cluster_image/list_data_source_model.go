...
type CloudGPUVirtualClusterImagesResultsListDataSourceEnvelope struct {
	Results customfield.NestedObjectList[CloudGPUVirtualClusterImagesItemsDataSourceModel] `json:"results,computed"`
}

type CloudGPUVirtualClusterImagesDataSourceModel struct {
	ProjectID types.Int64                                                                    `tfsdk:"project_id" path:"project_id,optional"`
	RegionID  types.Int64                                                                    `tfsdk:"region_id" path:"region_id,optional"`
	MaxItems  types.Int64                                                                    `tfsdk:"max_items"`
	Items     customfield.NestedObjectList[CloudGPUVirtualClusterImagesItemsDataSourceModel] `tfsdk:"items"`
}

func (m *CloudGPUVirtualClusterImagesDataSourceModel) toListParams(_ context.Context) (params cloud.GPUVirtualClusterImageListParams, diags diag.Diagnostics) {
...
type CloudGPUVirtualClusterImagesItemsDataSourceModel struct {
	...
	Tags               customfield.NestedObjectList[CloudGPUVirtualClusterImagesTagsDataSourceModel] `tfsdk:"tags" json:"tags,computed"`
...
type CloudGPUVirtualClusterImagesTagsDataSourceModel struct {
