...
var _ datasource.DataSourceWithConfigValidators = (*CDNResourceDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"options": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"allowed_http_methods": schema.SingleNestedAttribute{
						Description: "HTTP methods allowed for content requests from the CDN.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsAllowedHTTPMethodsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
					...
					"brotli_compression": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsBrotliCompressionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"browser_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsBrowserCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cache_http_headers": schema.SingleNestedAttribute{
						...
						CustomType:         customfield.NewNestedObjectType[CDNResourceOptionsCacheHTTPHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cors": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsCorsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"country_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsCountryACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_cache": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNResourceOptionsDisableCacheDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_proxy_force_ranges": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsDisableProxyForceRangesDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"edge_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsEdgeCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"fastedge": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFastedgeDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"on_request_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFastedgeOnRequestBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
							...
							"on_request_headers_after_cache": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFastedgeOnRequestHeadersAfterCacheDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFastedgeOnResponseBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_headers": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFastedgeOnResponseHeadersDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
					...
					"fetch_compressed": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFetchCompressedDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"follow_origin_redirect": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsFollowOriginRedirectDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"force_return": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsForceReturnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"time_interval": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsForceReturnTimeIntervalDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"gzip_on": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsGzipOnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"host_header": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsHostHeaderDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"http3_enabled": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsHttp3EnabledDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_cookie": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsIgnoreCookieDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_query_string": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsIgnoreQueryStringDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"image_stack": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsImageStackDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ip_address_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsIPAddressACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"limit_bandwidth": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsLimitBandwidthDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"network_error_logging": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsNetworkErrorLoggingDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsProxyCacheKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_methods_set": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsProxyCacheMethodsSetDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_connect_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsProxyConnectTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_read_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsProxyReadTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_blacklist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsQueryParamsBlacklistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_whitelist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsQueryParamsWhitelistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_string_forwarding": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsQueryStringForwardingDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_http_to_https": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsRedirectHTTPToHTTPSDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_https_to_http": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsRedirectHTTPSToHTTPDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"referrer_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsReferrerACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"response_headers_hiding_policy": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsResponseHeadersHidingPolicyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"rewrite": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsRewriteDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"body": schema.StringAttribute{
					...
					"secure_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsSecureKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"slice": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsSliceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"sni": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsSniDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"stale": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsStaleDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_response_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsStaticResponseHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"value": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNResourceOptionsStaticResponseHeadersValueDataSourceModel](ctx),
					...
					"static_headers": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNResourceOptionsStaticHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_request_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsStaticRequestHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"use_default_le_chain": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsUseDefaultLeChainDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"use_dns01_le_challenge": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsUseDns01LeChallengeDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"use_rsa_le_cert": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsUseRsaLeCertDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"user_agent_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsUserAgentACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"waap": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsWaapDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"websockets": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsWebsocketsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
...
func (d *CDNResourceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
