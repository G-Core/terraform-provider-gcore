			...
			"options": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"bot_protection": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsBotProtectionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"bot_challenge": schema.SingleNestedAttribute{
								Description: "Controls the bot challenge module state.",
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceOptionsBotProtectionBotChallengeDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
