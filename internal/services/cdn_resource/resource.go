...
var _ resource.ResourceWithConfigure = (*CDNResourceResource)(nil)
var _ resource.ResourceWithModifyPlan = (*CDNResourceResource)(nil)
var _ resource.ResourceWithImportState = (*CDNResourceResource)(nil)

func NewResource() resource.Resource {
	return &CDNResourceResource{}
}

// CDNResourceResource defines the resource implementation.
type CDNResourceResource struct {
	client *gcore.Client
}

func (r *CDNResourceResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cdn_resource"
}

func (r *CDNResourceResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *CDNResourceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.CDN.CDNResources.New(
		ctx,
		cdn.CDNResourceNewParams{},
...
func (r *CDNResourceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	res := new(http.Response)
	_, err = r.client.CDN.CDNResources.Update(
		ctx,
		data.ID.ValueInt64(),
...
func (r *CDNResourceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	res := new(http.Response)
	_, err := r.client.CDN.CDNResources.Get(
		ctx,
		data.ID.ValueInt64(),
		option.WithResponseBodyInto(&res),
		option.WithMiddleware(logging.Middleware(ctx)),
...
func (r *CDNResourceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.CDN.CDNResources.DeactivateAndDelete(
		ctx,
		data.ID.ValueInt64(),
		option.WithMiddleware(logging.Middleware(ctx)),
	)
...
func (r *CDNResourceResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
