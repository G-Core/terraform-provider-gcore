...
var _ datasource.DataSourceWithConfigValidators = (*CloudInstancesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"order_by": schema.StringAttribute{
				Description: "Order by field and direction.\nAvailable values: \"created.asc\", \"created.desc\", \"name.asc\", \"name.desc\".",
				Computed:    true,
				Optional:    true,
				Validators: []validator.String{
					stringvalidator.OneOfCaseInsensitive(
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudInstancesItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"addresses": schema.MapAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewMapType[customfield.NestedObjectList[CloudInstancesAddressesDataSourceModel]](ctx),
						...
						"blackhole_ports": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudInstancesBlackholePortsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"ddos_profile": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudInstancesDDOSProfileDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"id": schema.Int64Attribute{
								...
								"fields": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudInstancesDDOSProfileFieldsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"id": schema.Int64Attribute{
								...
								"options": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudInstancesDDOSProfileOptionsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"profile_template": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudInstancesDDOSProfileProfileTemplateDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.Int64Attribute{
										...
										"fields": schema.ListNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[CloudInstancesDDOSProfileProfileTemplateFieldsDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"id": schema.Int64Attribute{
														Description: "Unique identifier for the DDoS protection field",
								...
								"protocols": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudInstancesDDOSProfileProtocolsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
								...
								"status": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudInstancesDDOSProfileStatusDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"fixed_ip_assignments": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudInstancesFixedIPAssignmentsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"flavor": schema.SingleNestedAttribute{
							Description: "Flavor",
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudInstancesFlavorDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"hardware_description": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudInstancesFlavorHardwareDescriptionDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"instance_isolation": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudInstancesInstanceIsolationDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"security_groups": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudInstancesSecurityGroupsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description: "Name.",
						...
						"tags": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudInstancesTagsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"volumes": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudInstancesVolumesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
...
func (d *CloudInstancesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
