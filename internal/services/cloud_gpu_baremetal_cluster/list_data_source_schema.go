	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"limit": schema.Int64Attribute{
				Description: "Limit the number of returned clusters",
				Optional:    true,
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"interfaces": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersInterfacesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"servers": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									...
									"addresses": schema.MapAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewMapType[customfield.NestedObjectList[CloudGPUBaremetalClustersServersAddressesDataSourceModel]](ctx),
									...
									"blackhole_ports": schema.ListNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersBlackholePortsDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"ddos_profile": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersDDOSProfileDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"id": schema.Int64Attribute{
											...
											"fields": schema.ListNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersDDOSProfileFieldsDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"id": schema.Int64Attribute{
											...
											"options": schema.SingleNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersDDOSProfileOptionsDataSourceModel](ctx),
												Attributes: map[string]schema.Attribute{
											...
											"profile_template": schema.SingleNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateDataSourceModel](ctx),
												Attributes: map[string]schema.Attribute{
													"id": schema.Int64Attribute{
													...
													"fields": schema.ListNestedAttribute{
														...
														Computed:    true,
														CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateFieldsDataSourceModel](ctx),
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"id": schema.Int64Attribute{
																	Description: "Unique identifier for the DDoS protection field",
											...
											"protocols": schema.ListNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersDDOSProfileProtocolsDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
											...
											"status": schema.SingleNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersDDOSProfileStatusDataSourceModel](ctx),
												Attributes: map[string]schema.Attribute{
									...
									"fixed_ip_assignments": schema.ListNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersFixedIPAssignmentsDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"flavor": schema.SingleNestedAttribute{
										Description: "Flavor",
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersFlavorDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											...
											"hardware_description": schema.SingleNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersFlavorHardwareDescriptionDataSourceModel](ctx),
												Attributes: map[string]schema.Attribute{
									...
									"instance_isolation": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[CloudGPUBaremetalClustersServersInstanceIsolationDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"security_groups": schema.ListNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersSecurityGroupsDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"name": schema.StringAttribute{
													Description: "Name.",
									...
									"tags": schema.ListNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[CloudGPUBaremetalClustersServersTagsDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
