...
func (m *CloudGPUBaremetalClustersDataSourceModel) toListParams(_ context.Context) (params cloud.GPUBaremetalClusterListParams, diags diag.Diagnostics) {
...
type CloudGPUBaremetalClustersItemsDataSourceModel struct {
	...
	Interfaces    customfield.NestedObjectList[CloudGPUBaremetalClustersInterfacesDataSourceModel] `tfsdk:"interfaces" json:"interfaces,computed"`
	...
	Servers       customfield.NestedObjectList[CloudGPUBaremetalClustersServersDataSourceModel]    `tfsdk:"servers" json:"servers,computed"`
...
type CloudGPUBaremetalClustersInterfacesDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersDataSourceModel struct {
	ID                  types.String                                                                                            `tfsdk:"id" json:"id,computed"`
	Addresses           customfield.Map[customfield.NestedObjectList[CloudGPUBaremetalClustersServersAddressesDataSourceModel]] `tfsdk:"addresses" json:"addresses,computed"`
	BlackholePorts      customfield.NestedObjectList[CloudGPUBaremetalClustersServersBlackholePortsDataSourceModel]             `tfsdk:"blackhole_ports" json:"blackhole_ports,computed"`
	CreatedAt           timetypes.RFC3339                                                                                       `tfsdk:"created_at" json:"created_at,computed" format:"date-time"`
	CreatorTaskID       types.String                                                                                            `tfsdk:"creator_task_id" json:"creator_task_id,computed"`
	DDOSProfile         customfield.NestedObject[CloudGPUBaremetalClustersServersDDOSProfileDataSourceModel]                    `tfsdk:"ddos_profile" json:"ddos_profile,computed"`
	FixedIPAssignments  customfield.NestedObjectList[CloudGPUBaremetalClustersServersFixedIPAssignmentsDataSourceModel]         `tfsdk:"fixed_ip_assignments" json:"fixed_ip_assignments,computed"`
	Flavor              customfield.NestedObject[CloudGPUBaremetalClustersServersFlavorDataSourceModel]                         `tfsdk:"flavor" json:"flavor,computed"`
	InstanceDescription types.String                                                                                            `tfsdk:"instance_description" json:"instance_description,computed"`
	InstanceIsolation   customfield.NestedObject[CloudGPUBaremetalClustersServersInstanceIsolationDataSourceModel]              `tfsdk:"instance_isolation" json:"instance_isolation,computed"`
	Name                types.String                                                                                            `tfsdk:"name" json:"name,computed"`
	ProjectID           types.Int64                                                                                             `tfsdk:"project_id" json:"project_id,computed"`
	Region              types.String                                                                                            `tfsdk:"region" json:"region,computed"`
	RegionID            types.Int64                                                                                             `tfsdk:"region_id" json:"region_id,computed"`
	SecurityGroups      customfield.NestedObjectList[CloudGPUBaremetalClustersServersSecurityGroupsDataSourceModel]             `tfsdk:"security_groups" json:"security_groups,computed"`
	SSHKeyName          types.String                                                                                            `tfsdk:"ssh_key_name" json:"ssh_key_name,computed"`
	Status              types.String                                                                                            `tfsdk:"status" json:"status,computed"`
	Tags                customfield.NestedObjectList[CloudGPUBaremetalClustersServersTagsDataSourceModel]                       `tfsdk:"tags" json:"tags,computed"`
	TaskID              types.String                                                                                            `tfsdk:"task_id" json:"task_id,computed"`
...
type CloudGPUBaremetalClustersServersAddressesDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersBlackholePortsDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersDDOSProfileDataSourceModel struct {
	ID                         types.Int64                                                                                         `tfsdk:"id" json:"id,computed"`
	Fields                     customfield.NestedObjectList[CloudGPUBaremetalClustersServersDDOSProfileFieldsDataSourceModel]      `tfsdk:"fields" json:"fields,computed"`
	Options                    customfield.NestedObject[CloudGPUBaremetalClustersServersDDOSProfileOptionsDataSourceModel]         `tfsdk:"options" json:"options,computed"`
	ProfileTemplate            customfield.NestedObject[CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateDataSourceModel] `tfsdk:"profile_template" json:"profile_template,computed"`
	ProfileTemplateDescription types.String                                                                                        `tfsdk:"profile_template_description" json:"profile_template_description,computed"`
	Protocols                  customfield.NestedObjectList[CloudGPUBaremetalClustersServersDDOSProfileProtocolsDataSourceModel]   `tfsdk:"protocols" json:"protocols,computed"`
	Site                       types.String                                                                                        `tfsdk:"site" json:"site,computed"`
	Status                     customfield.NestedObject[CloudGPUBaremetalClustersServersDDOSProfileStatusDataSourceModel]          `tfsdk:"status" json:"status,computed"`
}

type CloudGPUBaremetalClustersServersDDOSProfileFieldsDataSourceModel struct {
	ID               types.Int64          `tfsdk:"id" json:"id,computed"`
...
type CloudGPUBaremetalClustersServersDDOSProfileOptionsDataSourceModel struct {
	Active types.Bool `tfsdk:"active" json:"active,computed"`
	Bgp    types.Bool `tfsdk:"bgp" json:"bgp,computed"`
}

type CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateDataSourceModel struct {
	ID          types.Int64                                                                                                   `tfsdk:"id" json:"id,computed"`
	Description types.String                                                                                                  `tfsdk:"description" json:"description,computed"`
	Fields      customfield.NestedObjectList[CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateFieldsDataSourceModel] `tfsdk:"fields" json:"fields,computed"`
	Name        types.String                                                                                                  `tfsdk:"name" json:"name,computed"`
}

type CloudGPUBaremetalClustersServersDDOSProfileProfileTemplateFieldsDataSourceModel struct {
	ID               types.Int64          `tfsdk:"id" json:"id,computed"`
	Default          types.String         `tfsdk:"default" json:"default,computed"`
	Description      types.String         `tfsdk:"description" json:"description,computed"`
	FieldType        types.String         `tfsdk:"field_type" json:"field_type,computed"`
...
type CloudGPUBaremetalClustersServersDDOSProfileProtocolsDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersDDOSProfileStatusDataSourceModel struct {
	ErrorDescription types.String `tfsdk:"error_description" json:"error_description,computed"`
	Status           types.String `tfsdk:"status" json:"status,computed"`
}

type CloudGPUBaremetalClustersServersFixedIPAssignmentsDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersFlavorDataSourceModel struct {
	...
	HardwareDescription customfield.NestedObject[CloudGPUBaremetalClustersServersFlavorHardwareDescriptionDataSourceModel] `tfsdk:"hardware_description" json:"hardware_description,computed"`
...
type CloudGPUBaremetalClustersServersFlavorHardwareDescriptionDataSourceModel struct {
...
type CloudGPUBaremetalClustersServersInstanceIsolationDataSourceModel struct {
	Reason types.String `tfsdk:"reason" json:"reason,computed"`
}

type CloudGPUBaremetalClustersServersSecurityGroupsDataSourceModel struct {
	Name types.String `tfsdk:"name" json:"name,computed"`
}

type CloudGPUBaremetalClustersServersTagsDataSourceModel struct {
