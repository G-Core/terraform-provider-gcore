...
type CloudGPUBaremetalClusterModel struct {
	...
	Interfaces     *[]*CloudGPUBaremetalClusterInterfacesModel                        `tfsdk:"interfaces" json:"interfaces,required"`
	...
	SecurityGroups *[]*CloudGPUBaremetalClusterSecurityGroupsModel                    `tfsdk:"security_groups" json:"security_groups,optional,no_refresh"`
	InstancesCount types.Int64                                                        `tfsdk:"instances_count" json:"instances_count,computed_optional,no_refresh"`
	...
	Servers        customfield.NestedObjectList[CloudGPUBaremetalClusterServersModel] `tfsdk:"servers" json:"servers,computed"`
}
...
type CloudGPUBaremetalClusterInterfacesModel struct {
	Type          types.String                                       `tfsdk:"type" json:"type,required"`
	InterfaceName types.String                                       `tfsdk:"interface_name" json:"interface_name,optional,no_refresh"`
	...
	FloatingIP    *CloudGPUBaremetalClusterInterfacesFloatingIPModel `tfsdk:"floating_ip" json:"floating_ip,optional,no_refresh"`
	IPAddress     types.String                                       `tfsdk:"ip_address" json:"ip_address,optional,no_refresh"`
}

type CloudGPUBaremetalClusterInterfacesFloatingIPModel struct {
	Source types.String `tfsdk:"source" json:"source,required"`
}

type CloudGPUBaremetalClusterSecurityGroupsModel struct {
	ID types.String `tfsdk:"id" json:"id,required"`
}

type CloudGPUBaremetalClusterServersModel struct {
	ID                  types.String                                                                                 `tfsdk:"id" json:"id,computed"`
	Addresses           customfield.Map[customfield.NestedObjectList[CloudGPUBaremetalClusterServersAddressesModel]] `tfsdk:"addresses" json:"addresses,computed"`
	BlackholePorts      customfield.NestedObjectList[CloudGPUBaremetalClusterServersBlackholePortsModel]             `tfsdk:"blackhole_ports" json:"blackhole_ports,computed"`
	CreatedAt           timetypes.RFC3339                                                                            `tfsdk:"created_at" json:"created_at,computed" format:"date-time"`
	CreatorTaskID       types.String                                                                                 `tfsdk:"creator_task_id" json:"creator_task_id,computed"`
	DDOSProfile         customfield.NestedObject[CloudGPUBaremetalClusterServersDDOSProfileModel]                    `tfsdk:"ddos_profile" json:"ddos_profile,computed"`
	FixedIPAssignments  customfield.NestedObjectList[CloudGPUBaremetalClusterServersFixedIPAssignmentsModel]         `tfsdk:"fixed_ip_assignments" json:"fixed_ip_assignments,computed"`
	Flavor              customfield.NestedObject[CloudGPUBaremetalClusterServersFlavorModel]                         `tfsdk:"flavor" json:"flavor,computed"`
	InstanceDescription types.String                                                                                 `tfsdk:"instance_description" json:"instance_description,computed"`
	InstanceIsolation   customfield.NestedObject[CloudGPUBaremetalClusterServersInstanceIsolationModel]              `tfsdk:"instance_isolation" json:"instance_isolation,computed"`
	Name                types.String                                                                                 `tfsdk:"name" json:"name,computed"`
	ProjectID           types.Int64                                                                                  `tfsdk:"project_id" json:"project_id,computed"`
	Region              types.String                                                                                 `tfsdk:"region" json:"region,computed"`
	RegionID            types.Int64                                                                                  `tfsdk:"region_id" json:"region_id,computed"`
	SecurityGroups      customfield.NestedObjectList[CloudGPUBaremetalClusterServersSecurityGroupsModel]             `tfsdk:"security_groups" json:"security_groups,computed"`
	SSHKeyName          types.String                                                                                 `tfsdk:"ssh_key_name" json:"ssh_key_name,computed"`
	Status              types.String                                                                                 `tfsdk:"status" json:"status,computed"`
	Tags                customfield.NestedObjectList[CloudGPUBaremetalClusterServersTagsModel]                       `tfsdk:"tags" json:"tags,computed"`
	TaskID              types.String                                                                                 `tfsdk:"task_id" json:"task_id,computed"`
...
type CloudGPUBaremetalClusterServersAddressesModel struct {
...
type CloudGPUBaremetalClusterServersBlackholePortsModel struct {
...
type CloudGPUBaremetalClusterServersDDOSProfileModel struct {
	ID                         types.Int64                                                                              `tfsdk:"id" json:"id,computed"`
	ProfileTemplate            customfield.NestedObject[CloudGPUBaremetalClusterServersDDOSProfileProfileTemplateModel] `tfsdk:"profile_template" json:"profile_template,computed"`
	Fields                     customfield.NestedObjectList[CloudGPUBaremetalClusterServersDDOSProfileFieldsModel]      `tfsdk:"fields" json:"fields,computed"`
	Options                    customfield.NestedObject[CloudGPUBaremetalClusterServersDDOSProfileOptionsModel]         `tfsdk:"options" json:"options,computed"`
	ProfileTemplateDescription types.String                                                                             `tfsdk:"profile_template_description" json:"profile_template_description,computed"`
	Protocols                  customfield.NestedObjectList[CloudGPUBaremetalClusterServersDDOSProfileProtocolsModel]   `tfsdk:"protocols" json:"protocols,computed"`
	Site                       types.String                                                                             `tfsdk:"site" json:"site,computed"`
	Status                     customfield.NestedObject[CloudGPUBaremetalClusterServersDDOSProfileStatusModel]          `tfsdk:"status" json:"status,computed"`
}

type CloudGPUBaremetalClusterServersDDOSProfileProfileTemplateModel struct {
	ID          types.Int64                                                                                        `tfsdk:"id" json:"id,computed"`
	Name        types.String                                                                                       `tfsdk:"name" json:"name,computed"`
	Description types.String                                                                                       `tfsdk:"description" json:"description,computed"`
	Fields      customfield.NestedObjectList[CloudGPUBaremetalClusterServersDDOSProfileProfileTemplateFieldsModel] `tfsdk:"fields" json:"fields,computed"`
}

type CloudGPUBaremetalClusterServersDDOSProfileProfileTemplateFieldsModel struct {
	ID               types.Int64          `tfsdk:"id" json:"id,computed"`
	Name             types.String         `tfsdk:"name" json:"name,computed"`
...
type CloudGPUBaremetalClusterServersDDOSProfileFieldsModel struct {
	ID               types.Int64          `tfsdk:"id" json:"id,computed"`
...
type CloudGPUBaremetalClusterServersDDOSProfileOptionsModel struct {
	Active types.Bool `tfsdk:"active" json:"active,computed"`
	Bgp    types.Bool `tfsdk:"bgp" json:"bgp,computed"`
}

type CloudGPUBaremetalClusterServersDDOSProfileProtocolsModel struct {
...
type CloudGPUBaremetalClusterServersDDOSProfileStatusModel struct {
	ErrorDescription types.String `tfsdk:"error_description" json:"error_description,computed"`
	Status           types.String `tfsdk:"status" json:"status,computed"`
}

type CloudGPUBaremetalClusterServersFixedIPAssignmentsModel struct {
...
type CloudGPUBaremetalClusterServersFlavorModel struct {
	...
	HardwareDescription customfield.NestedObject[CloudGPUBaremetalClusterServersFlavorHardwareDescriptionModel] `tfsdk:"hardware_description" json:"hardware_description,computed"`
...
type CloudGPUBaremetalClusterServersFlavorHardwareDescriptionModel struct {
...
type CloudGPUBaremetalClusterServersInstanceIsolationModel struct {
	Reason types.String `tfsdk:"reason" json:"reason,computed"`
}

type CloudGPUBaremetalClusterServersSecurityGroupsModel struct {
	Name types.String `tfsdk:"name" json:"name,computed"`
}

type CloudGPUBaremetalClusterServersTagsModel struct {
