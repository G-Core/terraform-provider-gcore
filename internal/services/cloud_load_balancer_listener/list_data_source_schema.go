...
var _ datasource.DataSourceWithConfigValidators = (*CloudLoadBalancerListenersDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLoadBalancerListenersItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"user_list": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudLoadBalancerListenersUserListDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
...
func (d *CloudLoadBalancerListenersDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
