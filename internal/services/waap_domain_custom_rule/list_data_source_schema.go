...
var _ datasource.DataSourceWithConfigValidators = (*WaapDomainCustomRulesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[WaapDomainCustomRulesItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"action": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesActionDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"block": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesActionBlockDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"tag": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesActionTagDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"conditions": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[WaapDomainCustomRulesConditionsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"content_type": schema.SingleNestedAttribute{
										Description: "Match the requested Content-Type",
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsContentTypeDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"country": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsCountryDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"file_extension": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsFileExtensionDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"header": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsHeaderDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"header_exists": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsHeaderExistsDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"header": schema.StringAttribute{
												Description: "The request header name",
												Computed:    true,
									...
									"http_method": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsHTTPMethodDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"ip": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsIPDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"ip_range": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsIPRangeDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"organization": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsOrganizationDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"owner_types": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsOwnerTypesDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"negation": schema.BoolAttribute{
												Description: "Whether or not to apply a boolean NOT operation to the rule's condition",
												Computed:    true,
									...
									"request_rate": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsRequestRateDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"response_header": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsResponseHeaderDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"header": schema.StringAttribute{
									...
									"response_header_exists": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsResponseHeaderExistsDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"header": schema.StringAttribute{
												Description: "The response header name",
												Computed:    true,
									...
									"session_request_count": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsSessionRequestCountDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"tags": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsTagsDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"tags": schema.ListAttribute{
									...
									"url": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsURLDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"user_agent": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsUserAgentDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"user_defined_tags": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainCustomRulesConditionsUserDefinedTagsDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
											"tags": schema.ListAttribute{
...
func (d *WaapDomainCustomRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *WaapDomainCustomRulesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
