...
var _ datasource.DataSourceWithConfigValidators = (*CDNLogsUploaderTargetDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"config": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"append": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigAppendDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"response_actions": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNLogsUploaderTargetConfigAppendResponseActionsDataSourceModel](ctx),
					...
					"auth": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigAuthDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"config": schema.SingleNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigAuthConfigDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"retry": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigRetryDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"headers": schema.MapAttribute{
								Computed:    true,
								CustomType:  customfield.NewMapType[types.String](ctx),
							...
							"response_actions": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNLogsUploaderTargetConfigRetryResponseActionsDataSourceModel](ctx),
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"action": schema.StringAttribute{
											Description: `Available values: "drop", "retry", "append".`,
					...
					"upload": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[CDNLogsUploaderTargetConfigUploadDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"headers": schema.MapAttribute{
								Computed:    true,
								CustomType:  customfield.NewMapType[types.String](ctx),
							...
							"response_actions": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNLogsUploaderTargetConfigUploadResponseActionsDataSourceModel](ctx),
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"action": schema.StringAttribute{
											Description: `Available values: "drop", "retry", "append".`,
...
func (d *CDNLogsUploaderTargetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CDNLogsUploaderTargetDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
