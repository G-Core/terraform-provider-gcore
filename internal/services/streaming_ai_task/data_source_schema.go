...
var _ datasource.DataSourceWithConfigValidators = (*StreamingAITaskDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"processing_time": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[StreamingAITaskProcessingTimeDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"result": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[StreamingAITaskResultDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"subtitles": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[StreamingAITaskResultSubtitlesDataSourceModel](ctx),
					...
					"frames": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[StreamingAITaskResultFramesDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
			...
			"task_data": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[StreamingAITaskTaskDataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"task_name": schema.StringAttribute{
...
func (d *StreamingAITaskDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *StreamingAITaskDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
