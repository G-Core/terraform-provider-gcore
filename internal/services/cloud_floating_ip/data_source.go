...
func (d *CloudFloatingIPDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudFloatingIPDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if data.FindOneBy != nil {
		...
		env := CloudFloatingIPsResultsListDataSourceEnvelope{}
		page, err := d.client.Cloud.FloatingIPs.List(ctx, params)
		if err != nil {
	...
	_, err := d.client.Cloud.FloatingIPs.Get(
		ctx,
		data.FloatingIPID.ValueString(),
		params,
