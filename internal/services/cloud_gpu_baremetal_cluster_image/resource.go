...
var _ resource.ResourceWithConfigure = (*CloudGPUBaremetalClusterImageResource)(nil)
var _ resource.ResourceWithModifyPlan = (*CloudGPUBaremetalClusterImageResource)(nil)
var _ resource.ResourceWithImportState = (*CloudGPUBaremetalClusterImageResource)(nil)

func NewResource() resource.Resource {
	return &CloudGPUBaremetalClusterImageResource{}
}

// CloudGPUBaremetalClusterImageResource defines the resource implementation.
type CloudGPUBaremetalClusterImageResource struct {
	client *gcore.Client
}

func (r *CloudGPUBaremetalClusterImageResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cloud_gpu_baremetal_cluster_image"
}

func (r *CloudGPUBaremetalClusterImageResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *CloudGPUBaremetalClusterImageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *CloudGPUBaremetalClusterImageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *CloudGPUBaremetalClusterImageModel
	...
	params := cloud.GPUBaremetalClusterImageDeleteParams{}
