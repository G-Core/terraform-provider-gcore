...
var _ datasource.DataSourceWithConfigValidators = (*CDNOriginGroupsDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CDNOriginGroupsItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"sources": schema.SetNestedAttribute{
							Description: "List of origin sources in the origin group. Each entry can be a host origin or an S3 origin.\n\nHost origins have a `source` field with the hostname or IP. S3 origins have `origin_type: s3`\nand a `config` object with S3 credentials. Both types can be mixed in the same origin group.",
							Computed:    true,
							CustomType:  customfield.NewNestedObjectSetType[CDNOriginGroupsSourcesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									...
									"config": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[CDNOriginGroupsSourcesConfigDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
						...
						"auth": schema.SingleNestedAttribute{
							...
							Computed:           true,
							DeprecationMessage: "This attribute is deprecated.",
							CustomType:         customfield.NewNestedObjectType[CDNOriginGroupsAuthDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"s3_access_key_id": schema.StringAttribute{
...
func (d *CDNOriginGroupsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CDNOriginGroupsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
