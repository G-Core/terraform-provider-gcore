...
var _ datasource.DataSourceWithConfigValidators = (*CloudK8SClustersDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudK8SClustersItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"add_ons": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersAddOnsDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"slurm": schema.SingleNestedAttribute{
									Description: "Slurm add-on configuration",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudK8SClustersAddOnsSlurmDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"csi": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersCsiDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"logging": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersLoggingDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"retention_policy": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudK8SClustersLoggingRetentionPolicyDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"pools": schema.ListNestedAttribute{
							Description: "pools",
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudK8SClustersPoolsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
						...
						"authentication": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersAuthenticationDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"oidc": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudK8SClustersAuthenticationOidcDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"cni": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersCniDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"cilium": schema.SingleNestedAttribute{
									Description: "Cilium settings",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudK8SClustersCniCiliumDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"ddos_profile": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudK8SClustersDDOSProfileDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"enabled": schema.BoolAttribute{
								...
								"fields": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudK8SClustersDDOSProfileFieldsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
...
func (d *CloudK8SClustersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CloudK8SClustersDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
