...
type CloudK8SClustersResultsListDataSourceEnvelope struct {
	Results customfield.NestedObjectList[CloudK8SClustersItemsDataSourceModel] `json:"results,computed"`
}

type CloudK8SClustersDataSourceModel struct {
	ProjectID types.Int64                                                        `tfsdk:"project_id" path:"project_id,optional"`
	RegionID  types.Int64                                                        `tfsdk:"region_id" path:"region_id,optional"`
	MaxItems  types.Int64                                                        `tfsdk:"max_items"`
	Items     customfield.NestedObjectList[CloudK8SClustersItemsDataSourceModel] `tfsdk:"items"`
}

func (m *CloudK8SClustersDataSourceModel) toListParams(_ context.Context) (params cloud.K8SClusterListParams, diags diag.Diagnostics) {
	params = cloud.K8SClusterListParams{}
...
type CloudK8SClustersItemsDataSourceModel struct {
	ID               types.String                                                            `tfsdk:"id" json:"id,computed"`
	AddOns           customfield.NestedObject[CloudK8SClustersAddOnsDataSourceModel]         `tfsdk:"add_ons" json:"add_ons,computed"`
	CreatedAt        types.String                                                            `tfsdk:"created_at" json:"created_at,computed"`
	Csi              customfield.NestedObject[CloudK8SClustersCsiDataSourceModel]            `tfsdk:"csi" json:"csi,computed"`
	IsPublic         types.Bool                                                              `tfsdk:"is_public" json:"is_public,computed"`
	Keypair          types.String                                                            `tfsdk:"keypair" json:"keypair,computed"`
	Logging          customfield.NestedObject[CloudK8SClustersLoggingDataSourceModel]        `tfsdk:"logging" json:"logging,computed"`
	Name             types.String                                                            `tfsdk:"name" json:"name,computed"`
	Pools            customfield.NestedObjectList[CloudK8SClustersPoolsDataSourceModel]      `tfsdk:"pools" json:"pools,computed"`
	Status           types.String                                                            `tfsdk:"status" json:"status,computed"`
	Version          types.String                                                            `tfsdk:"version" json:"version,computed"`
	Authentication   customfield.NestedObject[CloudK8SClustersAuthenticationDataSourceModel] `tfsdk:"authentication" json:"authentication,computed"`
	AutoscalerConfig customfield.Map[types.String]                                           `tfsdk:"autoscaler_config" json:"autoscaler_config,computed"`
	Cni              customfield.NestedObject[CloudK8SClustersCniDataSourceModel]            `tfsdk:"cni" json:"cni,computed"`
	CreatorTaskID    types.String                                                            `tfsdk:"creator_task_id" json:"creator_task_id,computed"`
	DDOSProfile      customfield.NestedObject[CloudK8SClustersDDOSProfileDataSourceModel]    `tfsdk:"ddos_profile" json:"ddos_profile,computed"`
...
type CloudK8SClustersAddOnsDataSourceModel struct {
	Slurm customfield.NestedObject[CloudK8SClustersAddOnsSlurmDataSourceModel] `tfsdk:"slurm" json:"slurm,computed"`
}

type CloudK8SClustersAddOnsSlurmDataSourceModel struct {
...
type CloudK8SClustersCsiDataSourceModel struct {
	Nfs customfield.NestedObject[CloudK8SClustersCsiNfsDataSourceModel] `tfsdk:"nfs" json:"nfs,computed"`
}
...
type CloudK8SClustersLoggingDataSourceModel struct {
	...
	RetentionPolicy     customfield.NestedObject[CloudK8SClustersLoggingRetentionPolicyDataSourceModel] `tfsdk:"retention_policy" json:"retention_policy,computed"`
}

type CloudK8SClustersLoggingRetentionPolicyDataSourceModel struct {
	Period types.Int64 `tfsdk:"period" json:"period,computed"`
}

type CloudK8SClustersPoolsDataSourceModel struct {
	ID                 types.String                   `tfsdk:"id" json:"id,computed"`
...
type CloudK8SClustersAuthenticationDataSourceModel struct {
	...
	Oidc                customfield.NestedObject[CloudK8SClustersAuthenticationOidcDataSourceModel] `tfsdk:"oidc" json:"oidc,computed"`
}

type CloudK8SClustersAuthenticationOidcDataSourceModel struct {
...
type CloudK8SClustersCniDataSourceModel struct {
	Cilium                  customfield.NestedObject[CloudK8SClustersCniCiliumDataSourceModel] `tfsdk:"cilium" json:"cilium,computed"`
	CloudK8SClusterProvider types.String                                                       `tfsdk:"cloud_k8s_cluster_provider" json:"provider,computed"`
}

type CloudK8SClustersCniCiliumDataSourceModel struct {
...
type CloudK8SClustersDDOSProfileDataSourceModel struct {
	Enabled             types.Bool                                                                     `tfsdk:"enabled" json:"enabled,computed"`
	Fields              customfield.NestedObjectList[CloudK8SClustersDDOSProfileFieldsDataSourceModel] `tfsdk:"fields" json:"fields,computed"`
...
type CloudK8SClustersDDOSProfileFieldsDataSourceModel struct {
