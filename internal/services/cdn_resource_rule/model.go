...
type CDNResourceRuleOptionsFastedgeModel struct {
	...
	OnRequestHeadersAfterCache customfield.NestedObject[CDNResourceRuleOptionsFastedgeOnRequestHeadersAfterCacheModel] `tfsdk:"on_request_headers_after_cache" json:"on_request_headers_after_cache,computed_optional"`
...
type CDNResourceRuleOptionsFastedgeOnRequestHeadersAfterCacheModel struct {
	AppID            types.String `tfsdk:"app_id" json:"app_id,required"`
	Enabled          types.Bool   `tfsdk:"enabled" json:"enabled,computed_optional"`
	ExecuteOnEdge    types.Bool   `tfsdk:"execute_on_edge" json:"execute_on_edge,computed_optional"`
	ExecuteOnShield  types.Bool   `tfsdk:"execute_on_shield" json:"execute_on_shield,computed_optional"`
