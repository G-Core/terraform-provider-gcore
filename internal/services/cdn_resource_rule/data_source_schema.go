...
var _ datasource.DataSourceWithConfigValidators = (*CDNResourceRuleDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"options": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"allowed_http_methods": schema.SingleNestedAttribute{
						Description: "HTTP methods allowed for content requests from the CDN.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsAllowedHTTPMethodsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"bot_protection": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsBotProtectionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"bot_challenge": schema.SingleNestedAttribute{
								Description: "Controls the bot challenge module state.",
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsBotProtectionBotChallengeDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
					...
					"brotli_compression": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsBrotliCompressionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"browser_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsBrowserCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cache_http_headers": schema.SingleNestedAttribute{
						...
						CustomType:         customfield.NewNestedObjectType[CDNResourceRuleOptionsCacheHTTPHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cors": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsCorsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"country_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsCountryACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_cache": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNResourceRuleOptionsDisableCacheDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_proxy_force_ranges": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsDisableProxyForceRangesDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"edge_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsEdgeCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"fastedge": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFastedgeDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"on_request_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFastedgeOnRequestBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
							...
							"on_request_headers": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFastedgeOnRequestHeadersDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFastedgeOnResponseBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_headers": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFastedgeOnResponseHeadersDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
					...
					"fetch_compressed": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFetchCompressedDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"follow_origin_redirect": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsFollowOriginRedirectDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"force_return": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsForceReturnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"time_interval": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsForceReturnTimeIntervalDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"forward_host_header": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsForwardHostHeaderDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"gzip_on": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsGzipOnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"host_header": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsHostHeaderDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_cookie": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsIgnoreCookieDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_query_string": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsIgnoreQueryStringDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"image_stack": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsImageStackDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ip_address_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsIPAddressACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"limit_bandwidth": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsLimitBandwidthDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsProxyCacheKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_methods_set": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsProxyCacheMethodsSetDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_connect_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsProxyConnectTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_read_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsProxyReadTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_blacklist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsQueryParamsBlacklistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_whitelist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsQueryParamsWhitelistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_string_forwarding": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsQueryStringForwardingDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_http_to_https": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsRedirectHTTPToHTTPSDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_https_to_http": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsRedirectHTTPSToHTTPDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"referrer_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsReferrerACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"request_limiter": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsRequestLimiterDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"response_headers_hiding_policy": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsResponseHeadersHidingPolicyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"rewrite": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsRewriteDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"body": schema.StringAttribute{
					...
					"secure_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsSecureKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"slice": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsSliceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"sni": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsSniDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"stale": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsStaleDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_response_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsStaticResponseHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"value": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNResourceRuleOptionsStaticResponseHeadersValueDataSourceModel](ctx),
					...
					"static_headers": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNResourceRuleOptionsStaticHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_request_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsStaticRequestHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"user_agent_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsUserAgentACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"waap": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsWaapDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"websockets": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNResourceRuleOptionsWebsocketsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
...
func (d *CDNResourceRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CDNResourceRuleDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
