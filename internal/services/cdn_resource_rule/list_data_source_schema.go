...
var _ datasource.DataSourceWithConfigValidators = (*CDNResourceRulesDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CDNResourceRulesItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"options": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"allowed_http_methods": schema.SingleNestedAttribute{
									Description: "HTTP methods allowed for content requests from the CDN.",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsAllowedHTTPMethodsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"bot_protection": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsBotProtectionDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"bot_challenge": schema.SingleNestedAttribute{
											Description: "Controls the bot challenge module state.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsBotProtectionBotChallengeDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"enabled": schema.BoolAttribute{
								...
								"brotli_compression": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsBrotliCompressionDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"browser_cache_settings": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsBrowserCacheSettingsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"cache_http_headers": schema.SingleNestedAttribute{
									...
									CustomType:         customfield.NewNestedObjectType[CDNResourceRulesOptionsCacheHTTPHeadersDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"cors": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsCorsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"country_acl": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsCountryACLDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"disable_cache": schema.SingleNestedAttribute{
									...
									Computed:           true,
									DeprecationMessage: "This attribute is deprecated.",
									CustomType:         customfield.NewNestedObjectType[CDNResourceRulesOptionsDisableCacheDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"disable_proxy_force_ranges": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsDisableProxyForceRangesDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"edge_cache_settings": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsEdgeCacheSettingsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"fastedge": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFastedgeDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
										...
										"on_request_body": schema.SingleNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFastedgeOnRequestBodyDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
										...
										"on_request_headers": schema.SingleNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFastedgeOnRequestHeadersDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"app_id": schema.StringAttribute{
													Description: "The ID of the application in FastEdge.",
													Computed:    true,
										...
										"on_response_body": schema.SingleNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFastedgeOnResponseBodyDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"app_id": schema.StringAttribute{
													Description: "The ID of the application in FastEdge.",
													Computed:    true,
										...
										"on_response_headers": schema.SingleNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFastedgeOnResponseHeadersDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"app_id": schema.StringAttribute{
													Description: "The ID of the application in FastEdge.",
													Computed:    true,
								...
								"fetch_compressed": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFetchCompressedDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"follow_origin_redirect": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsFollowOriginRedirectDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"force_return": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsForceReturnDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										...
										"time_interval": schema.SingleNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsForceReturnTimeIntervalDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
								...
								"forward_host_header": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsForwardHostHeaderDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"gzip_on": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsGzipOnDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"host_header": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsHostHeaderDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"ignore_cookie": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsIgnoreCookieDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"ignore_query_string": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsIgnoreQueryStringDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"image_stack": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsImageStackDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"ip_address_acl": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsIPAddressACLDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"limit_bandwidth": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsLimitBandwidthDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"proxy_cache_key": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsProxyCacheKeyDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"proxy_cache_methods_set": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsProxyCacheMethodsSetDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"proxy_connect_timeout": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsProxyConnectTimeoutDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"proxy_read_timeout": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsProxyReadTimeoutDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"query_params_blacklist": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsQueryParamsBlacklistDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"query_params_whitelist": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsQueryParamsWhitelistDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"query_string_forwarding": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsQueryStringForwardingDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"redirect_http_to_https": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsRedirectHTTPToHTTPSDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"redirect_https_to_http": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsRedirectHTTPSToHTTPDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"referrer_acl": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsReferrerACLDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"request_limiter": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsRequestLimiterDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"response_headers_hiding_policy": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsResponseHeadersHidingPolicyDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"rewrite": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsRewriteDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"body": schema.StringAttribute{
								...
								"secure_key": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsSecureKeyDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"slice": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsSliceDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"sni": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsSniDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"stale": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsStaleDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"static_response_headers": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsStaticResponseHeadersDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
										...
										"value": schema.ListNestedAttribute{
											Computed:   true,
											CustomType: customfield.NewNestedObjectListType[CDNResourceRulesOptionsStaticResponseHeadersValueDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"name": schema.StringAttribute{
								...
								"static_headers": schema.SingleNestedAttribute{
									...
									Computed:           true,
									DeprecationMessage: "This attribute is deprecated.",
									CustomType:         customfield.NewNestedObjectType[CDNResourceRulesOptionsStaticHeadersDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"static_request_headers": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsStaticRequestHeadersDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"user_agent_acl": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsUserAgentACLDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"waap": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsWaapDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
								...
								"websockets": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CDNResourceRulesOptionsWebsocketsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"enabled": schema.BoolAttribute{
											Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
											Computed:    true,
						...
						"preset_applied": schema.BoolAttribute{
							Description: "Defines whether the rule has an applied preset.\n\nPossible values:\n- **true** - Rule has a preset applied.\n- **false** - Rule does not have a preset applied.\n\nIf a preset is applied to the rule, the options included in the preset cannot be edited for the rule.",
							Computed:    true,
						},
						"primary_rule": schema.Int64Attribute{
							Description: "ID of the rule with which the current rule is synchronized within the CDN resource shared cache zone feature.",
							Computed:    true,
						},
...
func (d *CDNResourceRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CDNResourceRulesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
