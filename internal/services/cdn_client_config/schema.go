...
var _ resource.ResourceWithConfigValidators = (*CDNClientConfigResource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"service": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CDNClientConfigServiceModel](ctx),
				Attributes: map[string]schema.Attribute{
...
func (r *CDNClientConfigResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = ResourceSchema(ctx)
}

func (r *CDNClientConfigResource) ConfigValidators(_ context.Context) []resource.ConfigValidator {
