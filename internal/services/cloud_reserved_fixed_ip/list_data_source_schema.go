	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudReservedFixedIPsItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"allowed_address_pairs": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudReservedFixedIPsAllowedAddressPairsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"ip_address": schema.StringAttribute{
						...
						"attachments": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudReservedFixedIPsAttachmentsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"network": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudReservedFixedIPsNetworkDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"tags": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudReservedFixedIPsNetworkTagsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
						...
						"reservation": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudReservedFixedIPsReservationDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"resource_id": schema.StringAttribute{
...
func (d *CloudReservedFixedIPsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CloudReservedFixedIPsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
