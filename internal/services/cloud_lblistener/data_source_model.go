...
type CloudLblistenerDataSourceModel struct {
	...
	Stats                customfield.NestedObject[CloudLblistenerStatsDataSourceModel]        `tfsdk:"stats" json:"stats,computed"`
	UserList             customfield.NestedObjectList[CloudLblistenerUserListDataSourceModel] `tfsdk:"user_list" json:"user_list,computed"`
	InsertHeaders        jsontypes.Normalized                                                 `tfsdk:"insert_headers" json:"insert_headers,computed"`
}

func (m *CloudLblistenerDataSourceModel) toReadParams(_ context.Context) (params cloud.LoadBalancerListenerGetParams, diags diag.Diagnostics) {
...
type CloudLblistenerStatsDataSourceModel struct {
...
type CloudLblistenerUserListDataSourceModel struct {
