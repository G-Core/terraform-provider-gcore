...
var _ datasource.DataSourceWithConfigValidators = (*CloudLblistenerDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"stats": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudLblistenerStatsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"user_list": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLblistenerUserListDataSourceModel](ctx),
...
func (d *CloudLblistenerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CloudLblistenerDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
