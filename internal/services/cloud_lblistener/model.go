...
type CloudLblistenerModel struct {
	...
	UserList             *[]*CloudLblistenerUserListModel                    `tfsdk:"user_list" json:"user_list,optional"`
	...
	Stats                customfield.NestedObject[CloudLblistenerStatsModel] `tfsdk:"stats" json:"stats,computed"`
	InsertHeaders        jsontypes.Normalized                                `tfsdk:"insert_headers" json:"insert_headers,computed"`
}

func (m CloudLblistenerModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m CloudLblistenerModel) MarshalJSONForUpdate(state CloudLblistenerModel) (data []byte, err error) {
	return apijson.MarshalForPatch(m, state)
}

type CloudLblistenerUserListModel struct {
...
type CloudLblistenerStatsModel struct {
