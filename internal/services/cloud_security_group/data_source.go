...
func (d *CloudSecurityGroupDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudSecurityGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if data.FindOneBy != nil {
		...
		env := CloudSecurityGroupsResultsListDataSourceEnvelope{}
		page, err := d.client.Cloud.SecurityGroups.List(ctx, params)
		if err != nil {
	...
	_, err := d.client.Cloud.SecurityGroups.Get(
		ctx,
