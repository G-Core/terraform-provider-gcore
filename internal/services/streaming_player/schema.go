...
var _ resource.ResourceWithConfigValidators = (*StreamingPlayerResource)(nil)
...
func ResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"player": schema.SingleNestedAttribute{
				Description: "Set of properties for displaying videos. All parameters may be blank to inherit their values from default Streaming player.",
				Optional:    true,
				Attributes: map[string]schema.Attribute{
...
func (r *StreamingPlayerResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = ResourceSchema(ctx)
}

func (r *StreamingPlayerResource) ConfigValidators(_ context.Context) []resource.ConfigValidator {
