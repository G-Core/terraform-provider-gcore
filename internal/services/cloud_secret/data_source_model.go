...
type CloudSecretDataSourceModel struct {
	...
	FindOneBy    *CloudSecretFindOneByDataSourceModel `tfsdk:"find_one_by"`
}
...
func (m *CloudSecretDataSourceModel) toListParams(_ context.Context) (params cloud.SecretListParams, diags diag.Diagnostics) {
...
type CloudSecretFindOneByDataSourceModel struct {
