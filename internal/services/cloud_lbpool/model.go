...
type CloudLbpoolModel struct {
	...
	Healthmonitor        *CloudLbpoolHealthmonitorModel                              `tfsdk:"healthmonitor" json:"healthmonitor,optional"`
	SessionPersistence   *CloudLbpoolSessionPersistenceModel                         `tfsdk:"session_persistence" json:"session_persistence,optional"`
	...
	Listeners            customfield.NestedObjectList[CloudLbpoolListenersModel]     `tfsdk:"listeners" json:"listeners,computed"`
	Loadbalancers        customfield.NestedObjectList[CloudLbpoolLoadbalancersModel] `tfsdk:"loadbalancers" json:"loadbalancers,computed"`
}

func (m CloudLbpoolModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m CloudLbpoolModel) MarshalJSONForUpdate(state CloudLbpoolModel) (data []byte, err error) {
	return apijson.MarshalForPatch(m, state)
}

type CloudLbpoolHealthmonitorModel struct {
...
type CloudLbpoolSessionPersistenceModel struct {
	Type                   types.String `tfsdk:"type" json:"type,required"`
...
type CloudLbpoolMembersModel struct {
...
type CloudLbpoolListenersModel struct {
	ID types.String `tfsdk:"id" json:"id,computed"`
}

type CloudLbpoolLoadbalancersModel struct {
	ID types.String `tfsdk:"id" json:"id,computed"`
}
