...
var _ datasource.DataSourceWithConfigValidators = (*CloudLbpoolDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"healthmonitor": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudLbpoolHealthmonitorDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"id": schema.StringAttribute{
			...
			"listeners": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLbpoolListenersDataSourceModel](ctx),
			...
			"loadbalancers": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLbpoolLoadbalancersDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							Description: "Resource ID",
			...
			"members": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLbpoolMembersDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
			...
			"session_persistence": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudLbpoolSessionPersistenceDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"type": schema.StringAttribute{
...
func (d *CloudLbpoolDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CloudLbpoolDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
