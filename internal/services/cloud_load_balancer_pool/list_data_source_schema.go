...
var _ datasource.DataSourceWithConfigValidators = (*CloudLoadBalancerPoolsDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudLoadBalancerPoolsItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"healthmonitor": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudLoadBalancerPoolsHealthmonitorDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"id": schema.StringAttribute{
						...
						"loadbalancers": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CloudLoadBalancerPoolsLoadbalancersDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
										Description: "Resource ID",
						...
						"session_persistence": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudLoadBalancerPoolsSessionPersistenceDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"type": schema.StringAttribute{
...
func (d *CloudLoadBalancerPoolsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
