...
var _ datasource.DataSourceWithConfigValidators = (*CloudBaremetalServerDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"addresses": schema.MapAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewMapType[customfield.NestedObjectList[CloudBaremetalServerAddressesDataSourceModel]](ctx),
			...
			"blackhole_ports": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServerBlackholePortsDataSourceModel](ctx),
			...
			"fixed_ip_assignments": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServerFixedIPAssignmentsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
			...
			"flavor": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudBaremetalServerFlavorDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"hardware_description": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CloudBaremetalServerFlavorHardwareDescriptionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
			...
			"instance_isolation": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudBaremetalServerInstanceIsolationDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"tags": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServerTagsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
...
func (d *CloudBaremetalServerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CloudBaremetalServerDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
	return []datasource.ConfigValidator{
		datasourcevalidator.ExactlyOneOf(path.MatchRoot("server_id"), path.MatchRoot("find_one_by")),
	}
}
