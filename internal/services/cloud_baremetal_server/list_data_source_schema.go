				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"ddos_profile": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[CloudBaremetalServersDDOSProfileDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"id": schema.Int64Attribute{
								...
								"fields": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServersDDOSProfileFieldsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"id": schema.Int64Attribute{
								...
								"options": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudBaremetalServersDDOSProfileOptionsDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"profile_template": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudBaremetalServersDDOSProfileProfileTemplateDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.Int64Attribute{
										...
										"fields": schema.ListNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServersDDOSProfileProfileTemplateFieldsDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"id": schema.Int64Attribute{
														Description: "Unique identifier for the DDoS protection field",
								...
								"protocols": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[CloudBaremetalServersDDOSProfileProtocolsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
								...
								"status": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[CloudBaremetalServersDDOSProfileStatusDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
