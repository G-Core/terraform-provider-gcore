...
var _ datasource.DataSourceWithConfigValidators = (*CloudK8SFlavorsDataSource)(nil)
...
func ListDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"exclude_gpu": schema.BoolAttribute{
				Description: "Set to true to exclude GPU flavors. Default is false.",
				Computed:    true,
				Optional:    true,
			},
			"include_capacity": schema.BoolAttribute{
				Description: "Set to true to include flavor capacity. Default is False.",
				Computed:    true,
				Optional:    true,
			},
			"include_prices": schema.BoolAttribute{
				Description: "Set to true to include flavor prices. Default is False.",
				Computed:    true,
				Optional:    true,
			},
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[CloudK8SFlavorsItemsDataSourceModel](ctx),
...
func (d *CloudK8SFlavorsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *CloudK8SFlavorsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
