	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"options": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"allowed_http_methods": schema.SingleNestedAttribute{
						Description: "HTTP methods allowed for content requests from the CDN.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsAllowedHTTPMethodsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"bot_protection": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsBotProtectionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"bot_challenge": schema.SingleNestedAttribute{
								Description: "Controls the bot challenge module state.",
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsBotProtectionBotChallengeDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
					...
					"brotli_compression": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsBrotliCompressionDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"browser_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsBrowserCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cache_http_headers": schema.SingleNestedAttribute{
						...
						CustomType:         customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsCacheHTTPHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"cors": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsCorsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"country_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsCountryACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_cache": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsDisableCacheDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"disable_proxy_force_ranges": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsDisableProxyForceRangesDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"edge_cache_settings": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsEdgeCacheSettingsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"fastedge": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFastedgeDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"on_request_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFastedgeOnRequestBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
							...
							"on_request_headers": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFastedgeOnRequestHeadersDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_body": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFastedgeOnResponseBodyDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
							...
							"on_response_headers": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFastedgeOnResponseHeadersDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"app_id": schema.StringAttribute{
										Description: "The ID of the application in FastEdge.",
										Computed:    true,
					...
					"fetch_compressed": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFetchCompressedDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"follow_origin_redirect": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsFollowOriginRedirectDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"force_return": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsForceReturnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"time_interval": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsForceReturnTimeIntervalDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"forward_host_header": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsForwardHostHeaderDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"gzip_on": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsGzipOnDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"host_header": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsHostHeaderDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_cookie": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsIgnoreCookieDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ignore_query_string": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsIgnoreQueryStringDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"image_stack": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsImageStackDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"ip_address_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsIPAddressACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"limit_bandwidth": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsLimitBandwidthDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsProxyCacheKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_cache_methods_set": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsProxyCacheMethodsSetDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_connect_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsProxyConnectTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"proxy_read_timeout": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsProxyReadTimeoutDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_blacklist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsQueryParamsBlacklistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_params_whitelist": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsQueryParamsWhitelistDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"query_string_forwarding": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsQueryStringForwardingDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_http_to_https": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsRedirectHTTPToHTTPSDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"redirect_https_to_http": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsRedirectHTTPSToHTTPDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"referrer_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsReferrerACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"request_limiter": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsRequestLimiterDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"response_headers_hiding_policy": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsResponseHeadersHidingPolicyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"rewrite": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsRewriteDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"body": schema.StringAttribute{
					...
					"secure_key": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsSecureKeyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"slice": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsSliceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"sni": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsSniDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"stale": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsStaleDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_response_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsStaticResponseHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
							...
							"value": schema.ListNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectListType[CDNCDNResourceRuleOptionsStaticResponseHeadersValueDataSourceModel](ctx),
					...
					"static_headers": schema.SingleNestedAttribute{
						...
						Computed:           true,
						DeprecationMessage: "This attribute is deprecated.",
						CustomType:         customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsStaticHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"static_request_headers": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsStaticRequestHeadersDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"user_agent_acl": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsUserAgentACLDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"waap": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsWaapDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
					...
					"websockets": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CDNCDNResourceRuleOptionsWebsocketsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description: "Controls the option state.\n\nPossible values:\n- **true** - Option is enabled.\n- **false** - Option is disabled.",
								Computed:    true,
...
func (d *CDNCDNResourceRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CDNCDNResourceRuleDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
