...
type CDNTrustedCaCertificatesResultsListDataSourceEnvelope struct {
	Results customfield.NestedObjectList[CDNTrustedCaCertificatesItemsDataSourceModel] `json:"results,computed"`
}

type CDNTrustedCaCertificatesDataSourceModel struct {
	...
	Items               customfield.NestedObjectList[CDNTrustedCaCertificatesItemsDataSourceModel] `tfsdk:"items"`
}

func (m *CDNTrustedCaCertificatesDataSourceModel) toListParams(_ context.Context) (params cdn.TrustedCaCertificateListParams, diags diag.Diagnostics) {
...
type CDNTrustedCaCertificatesItemsDataSourceModel struct {
