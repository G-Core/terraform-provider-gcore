...
var _ datasource.DataSourceWithConfigValidators = (*CloudQuotaRequestDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"requested_limits": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[CloudQuotaRequestRequestedLimitsDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"global_limits": schema.SingleNestedAttribute{
						Description: "Global entity quota limits",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[CloudQuotaRequestRequestedLimitsGlobalLimitsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"regional_limits": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[CloudQuotaRequestRequestedLimitsRegionalLimitsDataSourceModel](ctx),
...
func (d *CloudQuotaRequestDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *CloudQuotaRequestDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
