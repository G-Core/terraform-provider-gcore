...
type CloudQuotaRequestsResultsListDataSourceEnvelope struct {
	Results customfield.NestedObjectList[CloudQuotaRequestsItemsDataSourceModel] `json:"results,computed"`
}

type CloudQuotaRequestsDataSourceModel struct {
	Status   *[]types.String                                                      `tfsdk:"status" query:"status,optional"`
	Limit    types.Int64                                                          `tfsdk:"limit" query:"limit,computed_optional"`
	MaxItems types.Int64                                                          `tfsdk:"max_items"`
	Items    customfield.NestedObjectList[CloudQuotaRequestsItemsDataSourceModel] `tfsdk:"items"`
}
...
type CloudQuotaRequestsItemsDataSourceModel struct {
	ID              types.Int64                                                                `tfsdk:"id" json:"id,computed"`
	ClientID        types.Int64                                                                `tfsdk:"client_id" json:"client_id,computed"`
	RequestedLimits customfield.NestedObject[CloudQuotaRequestsRequestedLimitsDataSourceModel] `tfsdk:"requested_limits" json:"requested_limits,computed"`
...
type CloudQuotaRequestsRequestedLimitsDataSourceModel struct {
	GlobalLimits   customfield.NestedObject[CloudQuotaRequestsRequestedLimitsGlobalLimitsDataSourceModel]       `tfsdk:"global_limits" json:"global_limits,computed"`
	RegionalLimits customfield.NestedObjectList[CloudQuotaRequestsRequestedLimitsRegionalLimitsDataSourceModel] `tfsdk:"regional_limits" json:"regional_limits,computed"`
}

type CloudQuotaRequestsRequestedLimitsGlobalLimitsDataSourceModel struct {
...
type CloudQuotaRequestsRequestedLimitsRegionalLimitsDataSourceModel struct {
