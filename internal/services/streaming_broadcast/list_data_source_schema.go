...
var _ datasource.DataSourceWithConfigValidators = (*StreamingBroadcastsDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StreamingBroadcastsItemsDataSourceModel](ctx),
...
func (d *StreamingBroadcastsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *StreamingBroadcastsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
