...
var _ datasource.DataSourceWithConfigValidators = (*WaapDomainInsightSilencesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[WaapDomainInsightSilencesItemsDataSourceModel](ctx),
...
func (d *WaapDomainInsightSilencesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *WaapDomainInsightSilencesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
