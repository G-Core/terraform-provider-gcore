...
func (d *CloudInstanceImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudInstanceImageDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *CloudInstanceImageDataSourceModel
	...
	_, err := d.client.Cloud.Instances.Images.Get(
		ctx,
