...
type CloudInstanceImagesResultsListDataSourceEnvelope struct {
	Results customfield.NestedObjectList[CloudInstanceImagesItemsDataSourceModel] `json:"results,computed"`
}

type CloudInstanceImagesDataSourceModel struct {
	...
	Items         customfield.NestedObjectList[CloudInstanceImagesItemsDataSourceModel] `tfsdk:"items"`
}

func (m *CloudInstanceImagesDataSourceModel) toListParams(_ context.Context) (params cloud.InstanceImageListParams, diags diag.Diagnostics) {
	mTagKey := []string{}
	if m.TagKey != nil {
	...
	if !m.Architecture.IsNull() {
		params.Architecture = cloud.InstanceImageListParamsArchitecture(m.Architecture.ValueString())
	}
	...
	if !m.Visibility.IsNull() {
		params.Visibility = cloud.InstanceImageListParamsVisibility(m.Visibility.ValueString())
	}

	return
}

type CloudInstanceImagesItemsDataSourceModel struct {
	...
	TagsV2           customfield.NestedObjectList[CloudInstanceImagesTagsV2DataSourceModel] `tfsdk:"tags_v2" json:"tags_v2,computed"`
	TaskID           types.String                                                           `tfsdk:"task_id" json:"task_id,computed"`
	UpdatedAt        timetypes.RFC3339                                                      `tfsdk:"updated_at" json:"updated_at,computed" format:"date-time"`
	Visibility       types.String                                                           `tfsdk:"visibility" json:"visibility,computed"`
}

type CloudInstanceImagesTagsV2DataSourceModel struct {
