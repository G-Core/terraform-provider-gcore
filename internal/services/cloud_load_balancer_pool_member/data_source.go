...
func (d *CloudLoadBalancerPoolMemberDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudLoadBalancerPoolMemberDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *CloudLoadBalancerPoolMemberDataSourceModel
	...
	_, err := d.client.Cloud.LoadBalancers.Pools.Members.Get(
		ctx,
