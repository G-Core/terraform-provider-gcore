...
var _ datasource.DataSourceWithConfigValidators = (*StreamingPlaylistDataSource)(nil)
...
func (d *StreamingPlaylistDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *StreamingPlaylistDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
