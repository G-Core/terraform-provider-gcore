...
func (d *CloudSSHKeyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudSSHKeyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	_, err := d.client.Cloud.SSHKeys.Get(
		ctx,
		data.SSHKeyID.ValueString(),
		params,
