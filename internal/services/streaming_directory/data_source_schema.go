...
var _ datasource.DataSourceWithConfigValidators = (*StreamingDirectoryDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"directory": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[StreamingDirectoryDirectoryDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"items_count": schema.Int64Attribute{
						Description: "Number of objects in this directory. Counting files and folders. The quantity is calculated only at one level (not recursively in all subfolders).",
						Computed:    true,
					},
					...
					"updated_at": schema.StringAttribute{
						Description: "Time of last update of the directory entity. Datetime in ISO 8601 format.",
						Computed:    true,
					},
					"items": schema.ListNestedAttribute{
						Description: "Array of subdirectories, if any.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[StreamingDirectoryDirectoryItemsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"converted_videos": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[StreamingDirectoryDirectoryItemsConvertedVideosDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"id": schema.Int64Attribute{
								...
								"item_type": schema.StringAttribute{
									Description: "Type of the entity: directory, or video\nAvailable values: \"Video\", \"Directory\".",
									Computed:    true,
									Validators: []validator.String{
										stringvalidator.OneOfCaseInsensitive("Video", "Directory"),
									},
								},
								"created_at": schema.StringAttribute{
									Description: "Time of creation. Datetime in ISO 8601 format.",
...
func (d *StreamingDirectoryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *StreamingDirectoryDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
