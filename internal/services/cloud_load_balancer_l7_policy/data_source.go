...
func (d *CloudLoadBalancerL7PolicyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CloudLoadBalancerL7PolicyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *CloudLoadBalancerL7PolicyDataSourceModel
	...
	_, err := d.client.Cloud.LoadBalancers.L7Policies.Get(
		ctx,
