...
var _ datasource.DataSourceWithConfigValidators = (*WaapDomainFirewallRulesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[WaapDomainFirewallRulesItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"action": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[WaapDomainFirewallRulesActionDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"block": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[WaapDomainFirewallRulesActionBlockDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
						...
						"conditions": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[WaapDomainFirewallRulesConditionsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"ip": schema.SingleNestedAttribute{
										Description: "Match the incoming request against a single IP address",
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainFirewallRulesConditionsIPDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
									...
									"ip_range": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[WaapDomainFirewallRulesConditionsIPRangeDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
...
func (d *WaapDomainFirewallRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *WaapDomainFirewallRulesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
