...
page_title: "gcore_cdn_trusted_ca_certificates Data Source - Gcore"
subcategory: ""
description: |-
  Trusted CA certificates verify the authenticity of CDN origin servers during HTTPS connections.
---

# gcore_cdn_trusted_ca_certificates (Data Source)
...
```terraform
data "gcore_cdn_trusted_ca_certificates" "example_cdn_trusted_ca_certificates" {
  automated = true
  resource_id = 0
...
- `automated` (Boolean) How the certificate was issued.

Possible values:
- **true** – Certificate was issued automatically.
- **false** – Certificate was added by a user.
- `max_items` (Number) Max items to fetch, default: 1000
- `resource_id` (Number) CDN resource ID for which the certificates are requested.
