...
page_title: "gcore_cdn_resources Data Source - Gcore"
subcategory: ""
description: |-
  
---

# gcore_cdn_resources (Data Source)
...
- `active` (Boolean) Defines whether a CDN resource is activated.

Possible values:
- **true** - CDN resource is activated.
- **false** - CDN resource is deactivated.
- `cname` (String) Delivery domain (CNAME) of the CDN resource.
- `deleted` (Boolean) Defines whether a CDN resource has been deleted.

Possible values:
- **true** - CDN resource has been deleted.
- **false** - CDN resource has not been deleted.
- `enabled` (Boolean) Enables or disables a CDN resource change by a user.

Possible values:
- **true** - CDN resource is enabled.
- **false** - CDN resource is disabled.
- `is_primary` (Boolean) Filters CDN resources by their primary/alternate relationship. Standalone
...
- `max_created` (String) Most recent date of CDN resource creation for which CDN resources should be returned (ISO 8601/RFC 3339 format, UTC.)
- `max_items` (Number) Max items to fetch, default: 1000
- `max_updated` (String) Most recent date of CDN resource update for which CDN resources should be returned (ISO 8601/RFC 3339 format, UTC.)
- `min_created` (String) Earliest date of CDN resource creation for which CDN resources should be returned (ISO 8601/RFC 3339 format, UTC.)
...
- `secondary_hostnames` (String) Additional delivery domains (CNAMEs) of the CDN resource.
- `shield_dc` (String) Name of the origin shielding data center location.
- `shielded` (Boolean) Defines whether origin shielding is enabled for the CDN resource.

Possible values:
- **true** - Origin shielding is enabled for the CDN resource.
- **false** - Origin shielding is disabled for the CDN resource.
- `ssl_data` (Number) SSL certificate ID.
- `ssl_data_in` (Number) SSL certificates IDs.

Example:
- ?`sslData_in`=1643,1644,1652
- `ssl_enabled` (Boolean) Defines whether the HTTPS protocol is enabled for content delivery.

Possible values:
- **true** - HTTPS protocol is enabled for CDN resource.
- **false** - HTTPS protocol is disabled for CDN resource.
- `status` (String) CDN resource status.
Available values: "active", "processed", "suspended", "deleted".
- `suspend` (Boolean) Defines whether the CDN resource was automatically suspended by the system.
...
- `suspended` (Boolean) Defines whether a CDN resource is currently suspended. This reflects the
...
- `deleted` (Boolean) Defines whether CDN resource has been deleted.
...
Option may inherit its value from the global account settings. (see [below for nested schema](#nestedatt--items--options))
...
- `secondary_hostnames` (List of String) Additional delivery domains (CNAMEs) that will be used to deliver content via the CDN.
...
<a id="nestedatt--items--options"></a>
### Nested Schema for `items.options`

Read-Only:

- `allowed_http_methods` (Attributes) HTTP methods allowed for content requests from the CDN. (see [below for nested schema](#nestedatt--items--options--allowed_http_methods))
...
Responses with other codes will not be cached. (see [below for nested schema](#nestedatt--items--options--browser_cache_settings))
- `cache_http_headers` (Attributes, Deprecated) **Legacy option**. Use the `response_headers_hiding_policy` option instead.

HTTP Headers that must be included in the response. (see [below for nested schema](#nestedatt--items--options--cache_http_headers))
- `cors` (Attributes) Enables or disables CORS (Cross-Origin Resource Sharing) header support.

CORS header support allows the CDN to add the Access-Control-Allow-Origin header to a response to a browser. (see [below for nested schema](#nestedatt--items--options--cors))
- `country_acl` (Attributes) Enables control access to content for specified countries. (see [below for nested schema](#nestedatt--items--options--country_acl))
- `disable_cache` (Attributes, Deprecated) **Legacy option**. Use the `edge_cache_settings` option instead.

Allows the complete disabling of content caching. (see [below for nested schema](#nestedatt--items--options--disable_cache))
- `disable_proxy_force_ranges` (Attributes) Allows 206 responses regardless of the settings of an origin source. (see [below for nested schema](#nestedatt--items--options--disable_proxy_force_ranges))
- `edge_cache_settings` (Attributes) Cache expiration time for CDN servers.

`value` and `default` fields cannot be used simultaneously. (see [below for nested schema](#nestedatt--items--options--edge_cache_settings))
- `fastedge` (Attributes) Allows to configure FastEdge app to be called on different request/response phases.

Note: At least one of `on_request_headers`, `on_request_headers_after_cache`, `on_request_body`, `on_response_headers`, or `on_response_body` must be specified. (see [below for nested schema](#nestedatt--items--options--fastedge))
...
2. `fetch_compressed` overrides `gzipON` and `brotli_compression` in rule. If you enable it in CDN resource and want to use `gzipON` and `brotli_compression` in a rule, you have to specify `"fetch_compressed": false` in the rule. (see [below for nested schema](#nestedatt--items--options--fetch_compressed))
- `follow_origin_redirect` (Attributes) Enables redirection from origin.
If the origin server returns a redirect, the option allows the CDN to pull the requested content from the origin server that was returned in the redirect. (see [below for nested schema](#nestedatt--items--options--follow_origin_redirect))
- `force_return` (Attributes) Applies custom HTTP response codes for CDN content.

The following codes are reserved by our system and cannot be specified in this option: 408, 444, 477, 494, 495, 496, 497, 499. (see [below for nested schema](#nestedatt--items--options--force_return))
- `forward_host_header` (Attributes) Forwards the Host header from a end-user request to an origin server.

`hostHeader` and `forward_host_header` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--forward_host_header))
- `grpc_passthrough` (Attributes) Enables gRPC pass-through for the CDN resource. (see [below for nested schema](#nestedatt--items--options--grpc_passthrough))
...
2. `fetch_compressed` option in CDN resource settings overrides `gzipON` in rules. If you enable `fetch_compressed` in CDN resource and want to enable `gzipON` in rules, you need to specify `"fetch_compressed":false` for rules. (see [below for nested schema](#nestedatt--items--options--gzip_on))
...
`hostHeader` and `forward_host_header` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--host_header))
- `http3_enabled` (Attributes) Enables HTTP/3 protocol for content delivery.

`http3_enabled` option works only with `"sslEnabled": true`. (see [below for nested schema](#nestedatt--items--options--http3_enabled))
- `ignore_cookie` (Attributes) Defines whether the files with the Set-Cookies header are cached as one file or as different ones. (see [below for nested schema](#nestedatt--items--options--ignore_cookie))
...
`ignoreQueryString`, `query_params_whitelist` and `query_params_blacklist` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--ignore_query_string))
- `image_stack` (Attributes) Transforms JPG and PNG images (for example, resize or crop) and automatically converts them to WebP or AVIF format. (see [below for nested schema](#nestedatt--items--options--image_stack))
...
We recommend you use a script for automatically update IP ACL. [Read more.](/docs/api-reference/cdn/ip-addresses-list/get-cdn-servers-ip-addresses) (see [below for nested schema](#nestedatt--items--options--ip_address_acl))
- `limit_bandwidth` (Attributes) Allows to control the download speed per connection. (see [below for nested schema](#nestedatt--items--options--limit_bandwidth))
...
observability of connectivity issues for the resource. (see [below for nested schema](#nestedatt--items--options--network_error_logging))
...
**Warning**: Enabling and changing this option can invalidate your current cache and affect the cache hit ratio. Furthermore, the "Purge by pattern" option will not work. (see [below for nested schema](#nestedatt--items--options--proxy_cache_key))
- `proxy_cache_methods_set` (Attributes) Caching for POST requests along with default GET and HEAD. (see [below for nested schema](#nestedatt--items--options--proxy_cache_methods_set))
- `proxy_connect_timeout` (Attributes) The time limit for establishing a connection with the origin. (see [below for nested schema](#nestedatt--items--options--proxy_connect_timeout))
...
**Note:**
When used with a WebSocket connection, this option supports values only in the range 1–20 seconds (instead of the usual 1–30 seconds). (see [below for nested schema](#nestedatt--items--options--proxy_read_timeout))
...
`ignoreQueryString`, `query_params_whitelist` and `query_params_blacklist` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--query_params_blacklist))
...
`ignoreQueryString`, `query_params_whitelist` and `query_params_blacklist` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--query_params_whitelist))
...
This is particularly useful for maintaining continuity in security, analytics, and any other parameter-based operations across the entire media delivery workflow. (see [below for nested schema](#nestedatt--items--options--query_string_forwarding))
- `redirect_http_to_https` (Attributes) Enables redirect from HTTP to HTTPS.

`redirect_http_to_https` and `redirect_https_to_http` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--redirect_http_to_https))
- `redirect_https_to_http` (Attributes) Enables redirect from HTTPS to HTTP.

`redirect_http_to_https` and `redirect_https_to_http` options cannot be enabled simultaneously. (see [below for nested schema](#nestedatt--items--options--redirect_https_to_http))
- `referrer_acl` (Attributes) Controls access to the CDN resource content for specified domain names. (see [below for nested schema](#nestedatt--items--options--referrer_acl))
- `response_headers_hiding_policy` (Attributes) Hides HTTP headers from an origin server in the CDN response. (see [below for nested schema](#nestedatt--items--options--response_headers_hiding_policy))
- `rewrite` (Attributes) Changes and redirects requests from the CDN to the origin. It operates according to the [Nginx](https://nginx.org/en/docs/http/ngx_http_rewrite_module.html#rewrite) configuration. (see [below for nested schema](#nestedatt--items--options--rewrite))
- `secure_key` (Attributes) Configures access with tokenized URLs. This makes impossible to access content without a valid (unexpired) token. (see [below for nested schema](#nestedatt--items--options--secure_key))
...
2. Not supported with `gzipON`, `brotli_compression` or `fetch_compressed` options enabled. (see [below for nested schema](#nestedatt--items--options--slice))
...
The option works only if `originProtocol` parameter is `HTTPS` or `MATCH`. (see [below for nested schema](#nestedatt--items--options--sni))
- `stale` (Attributes) Serves stale cached content in case of origin unavailability. (see [below for nested schema](#nestedatt--items--options--stale))
...
DNS service should be activated to enable this option. (see [below for nested schema](#nestedatt--items--options--use_dns01_le_challenge))
- `use_rsa_le_cert` (Attributes) RSA Let's Encrypt certificate type for the CDN resource.

The specified value will be used during the next Let's Encrypt certificate issue or renewal. (see [below for nested schema](#nestedatt--items--options--use_rsa_le_cert))
- `user_agent_acl` (Attributes) Controls access to the content for specified User-Agents. (see [below for nested schema](#nestedatt--items--options--user_agent_acl))
- `waap` (Attributes) Allows to enable WAAP (Web Application and API Protection). (see [below for nested schema](#nestedatt--items--options--waap))
- `websockets` (Attributes) Enables or disables WebSockets connections to an origin server. (see [below for nested schema](#nestedatt--items--options--websockets))

<a id="nestedatt--items--options--allowed_http_methods"></a>
### Nested Schema for `items.options.allowed_http_methods`
...
<a id="nestedatt--items--options--brotli_compression"></a>
### Nested Schema for `items.options.brotli_compression`
...
<a id="nestedatt--items--options--browser_cache_settings"></a>
### Nested Schema for `items.options.browser_cache_settings`
...
<a id="nestedatt--items--options--cache_http_headers"></a>
### Nested Schema for `items.options.cache_http_headers`
...
<a id="nestedatt--items--options--cors"></a>
### Nested Schema for `items.options.cors`
...
<a id="nestedatt--items--options--country_acl"></a>
### Nested Schema for `items.options.country_acl`
...
<a id="nestedatt--items--options--disable_cache"></a>
### Nested Schema for `items.options.disable_cache`
...
<a id="nestedatt--items--options--disable_proxy_force_ranges"></a>
### Nested Schema for `items.options.disable_proxy_force_ranges`
...
<a id="nestedatt--items--options--edge_cache_settings"></a>
### Nested Schema for `items.options.edge_cache_settings`
...
<a id="nestedatt--items--options--fastedge"></a>
### Nested Schema for `items.options.fastedge`
...
- **true** - Option is enabled.
- **false** - Option is disabled.
- `on_request_body` (Attributes) Allows to configure FastEdge application that will be called to handle request body as soon as CDN receives incoming HTTP request. (see [below for nested schema](#nestedatt--items--options--fastedge--on_request_body))
- `on_request_headers` (Attributes) Allows to configure FastEdge application that will be called to handle request headers as soon as CDN receives incoming HTTP request, **before cache**. (see [below for nested schema](#nestedatt--items--options--fastedge--on_request_headers))
- `on_request_headers_after_cache` (Attributes) Allows to configure FastEdge application that will be called to handle request headers as soon as CDN receives incoming HTTP request, **after cache**. (see [below for nested schema](#nestedatt--items--options--fastedge--on_request_headers_after_cache))
- `on_response_body` (Attributes) Allows to configure FastEdge application that will be called to handle response body before CDN sends the HTTP response. (see [below for nested schema](#nestedatt--items--options--fastedge--on_response_body))
- `on_response_headers` (Attributes) Allows to configure FastEdge application that will be called to handle response headers before CDN sends the HTTP response. (see [below for nested schema](#nestedatt--items--options--fastedge--on_response_headers))

<a id="nestedatt--items--options--fastedge--on_request_body"></a>
### Nested Schema for `items.options.fastedge.on_request_body`
...
<a id="nestedatt--items--options--fastedge--on_request_headers"></a>
### Nested Schema for `items.options.fastedge.on_request_headers`
...
<a id="nestedatt--items--options--fastedge--on_request_headers_after_cache"></a>
### Nested Schema for `items.options.fastedge.on_request_headers_after_cache`
...
<a id="nestedatt--items--options--fastedge--on_response_body"></a>
### Nested Schema for `items.options.fastedge.on_response_body`
...
<a id="nestedatt--items--options--fastedge--on_response_headers"></a>
### Nested Schema for `items.options.fastedge.on_response_headers`
...
<a id="nestedatt--items--options--fetch_compressed"></a>
### Nested Schema for `items.options.fetch_compressed`
...
<a id="nestedatt--items--options--follow_origin_redirect"></a>
### Nested Schema for `items.options.follow_origin_redirect`
...
<a id="nestedatt--items--options--force_return"></a>
### Nested Schema for `items.options.force_return`
...
- **true** - Option is enabled.
- **false** - Option is disabled.
- `time_interval` (Attributes) Controls the time at which a custom HTTP response code should be applied. By default, a custom HTTP response code is applied at any time. (see [below for nested schema](#nestedatt--items--options--force_return--time_interval))

<a id="nestedatt--items--options--force_return--time_interval"></a>
### Nested Schema for `items.options.force_return.time_interval`
...
<a id="nestedatt--items--options--forward_host_header"></a>
### Nested Schema for `items.options.forward_host_header`
...
<a id="nestedatt--items--options--grpc_passthrough"></a>
### Nested Schema for `items.options.grpc_passthrough`
...
<a id="nestedatt--items--options--gzip_on"></a>
### Nested Schema for `items.options.gzip_on`
...
<a id="nestedatt--items--options--host_header"></a>
### Nested Schema for `items.options.host_header`
...
<a id="nestedatt--items--options--http3_enabled"></a>
### Nested Schema for `items.options.http3_enabled`
...
<a id="nestedatt--items--options--ignore_cookie"></a>
### Nested Schema for `items.options.ignore_cookie`
...
<a id="nestedatt--items--options--ignore_query_string"></a>
### Nested Schema for `items.options.ignore_query_string`
...
<a id="nestedatt--items--options--image_stack"></a>
### Nested Schema for `items.options.image_stack`
...
<a id="nestedatt--items--options--ip_address_acl"></a>
### Nested Schema for `items.options.ip_address_acl`
...
<a id="nestedatt--items--options--limit_bandwidth"></a>
### Nested Schema for `items.options.limit_bandwidth`
...
<a id="nestedatt--items--options--network_error_logging"></a>
### Nested Schema for `items.options.network_error_logging`
...
<a id="nestedatt--items--options--proxy_cache_key"></a>
### Nested Schema for `items.options.proxy_cache_key`
...
<a id="nestedatt--items--options--proxy_cache_methods_set"></a>
### Nested Schema for `items.options.proxy_cache_methods_set`
...
<a id="nestedatt--items--options--proxy_connect_timeout"></a>
### Nested Schema for `items.options.proxy_connect_timeout`
...
<a id="nestedatt--items--options--proxy_read_timeout"></a>
### Nested Schema for `items.options.proxy_read_timeout`
...
<a id="nestedatt--items--options--query_params_blacklist"></a>
### Nested Schema for `items.options.query_params_blacklist`
...
<a id="nestedatt--items--options--query_params_whitelist"></a>
### Nested Schema for `items.options.query_params_whitelist`
...
<a id="nestedatt--items--options--query_string_forwarding"></a>
### Nested Schema for `items.options.query_string_forwarding`
...
<a id="nestedatt--items--options--redirect_http_to_https"></a>
### Nested Schema for `items.options.redirect_http_to_https`
...
<a id="nestedatt--items--options--redirect_https_to_http"></a>
### Nested Schema for `items.options.redirect_https_to_http`
...
<a id="nestedatt--items--options--referrer_acl"></a>
### Nested Schema for `items.options.referrer_acl`
...
<a id="nestedatt--items--options--response_headers_hiding_policy"></a>
### Nested Schema for `items.options.response_headers_hiding_policy`
...
<a id="nestedatt--items--options--rewrite"></a>
### Nested Schema for `items.options.rewrite`
...
<a id="nestedatt--items--options--secure_key"></a>
### Nested Schema for `items.options.secure_key`
...
<a id="nestedatt--items--options--slice"></a>
### Nested Schema for `items.options.slice`
...
<a id="nestedatt--items--options--sni"></a>
### Nested Schema for `items.options.sni`
...
<a id="nestedatt--items--options--stale"></a>
### Nested Schema for `items.options.stale`
...
<a id="nestedatt--items--options--static_headers"></a>
### Nested Schema for `items.options.static_headers`
...
<a id="nestedatt--items--options--static_request_headers"></a>
### Nested Schema for `items.options.static_request_headers`
...
<a id="nestedatt--items--options--static_response_headers"></a>
### Nested Schema for `items.options.static_response_headers`
...
- **true** - Option is enabled.
- **false** - Option is disabled.
- `value` (Attributes List) (see [below for nested schema](#nestedatt--items--options--static_response_headers--value))

<a id="nestedatt--items--options--static_response_headers--value"></a>
### Nested Schema for `items.options.static_response_headers.value`
...
### Nested Schema for `items.options.tls_versions`
...
<a id="nestedatt--items--options--use_default_le_chain"></a>
### Nested Schema for `items.options.use_default_le_chain`
...
<a id="nestedatt--items--options--use_dns01_le_challenge"></a>
### Nested Schema for `items.options.use_dns01_le_challenge`
...
<a id="nestedatt--items--options--use_rsa_le_cert"></a>
### Nested Schema for `items.options.use_rsa_le_cert`
...
<a id="nestedatt--items--options--user_agent_acl"></a>
### Nested Schema for `items.options.user_agent_acl`
...
<a id="nestedatt--items--options--waap"></a>
### Nested Schema for `items.options.waap`
...
<a id="nestedatt--items--options--websockets"></a>
### Nested Schema for `items.options.websockets`
