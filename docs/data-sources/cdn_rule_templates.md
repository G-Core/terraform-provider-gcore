...
page_title: "gcore_cdn_rule_templates Data Source - Gcore"
subcategory: ""
description: |-
...
# gcore_cdn_rule_templates (Data Source)
...
- `default` (Boolean) Defines whether the template is a system template developed for common cases. System templates are available to all customers.
...
- `deleted` (Boolean) Defines whether the template has been deleted.

Possible values:
- **true** - Template has been deleted.
- **false** - Template has not been deleted.
- `id` (Number) Rule template ID.
...
- `template` (Boolean) Determines whether the rule is a template.
