...
page_title: "gcore_cdn_cdn_resource_rule Data Source - gcore"
subcategory: ""
description: |-
...
# gcore_cdn_cdn_resource_rule (Data Source)
...
```terraform
data "gcore_cdn_cdn_resource_rule" "example_cdn_cdn_resource_rule" {
  resource_id = 0
  rule_id = 0
}
```
