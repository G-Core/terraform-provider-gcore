...
```terraform
data "gcore_cloud_secrets" "example_cloud_secrets" {
  project_id = 1
  region_id = 1
}
```
...
- `expiration` (String) Datetime when the secret will expire. The format is 2020-01-01T12:00:00+00:00. Null when no expiration was set.
