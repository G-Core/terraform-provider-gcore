...
- `details` (Boolean) Show members and Health Monitor details
...
- `healthmonitor` (Attributes) Health monitor parameters (see [below for nested schema](#nestedatt--items--healthmonitor))
- `id` (String) Pool ID
...
- `session_persistence` (Attributes) Session persistence parameters (see [below for nested schema](#nestedatt--items--session_persistence))
...
<a id="nestedatt--items--healthmonitor"></a>
### Nested Schema for `items.healthmonitor`
...
<a id="nestedatt--items--loadbalancers"></a>
### Nested Schema for `items.loadbalancers`
...
<a id="nestedatt--items--session_persistence"></a>
### Nested Schema for `items.session_persistence`
