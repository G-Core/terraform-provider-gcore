...
Option inherits its value from the CDN resource settings. (see [below for nested schema](#nestedatt--items--options))
...
- `bot_protection` (Attributes) Allows to prevent online services from overloading and ensure your business workflow running smoothly. (see [below for nested schema](#nestedatt--items--options--bot_protection))
...
Note: At least one of `on_request_headers`, `on_request_body`, `on_response_headers`, or `on_response_body` must be specified. (see [below for nested schema](#nestedatt--items--options--fastedge))
...
- `request_limiter` (Attributes) Option allows to limit the amount of HTTP requests. (see [below for nested schema](#nestedatt--items--options--request_limiter))
...
<a id="nestedatt--items--options--bot_protection"></a>
### Nested Schema for `items.options.bot_protection`

Read-Only:

- `bot_challenge` (Attributes) Controls the bot challenge module state. (see [below for nested schema](#nestedatt--items--options--bot_protection--bot_challenge))
- `enabled` (Boolean) Controls the option state.
...
<a id="nestedatt--items--options--bot_protection--bot_challenge"></a>
### Nested Schema for `items.options.bot_protection.bot_challenge`
...
<a id="nestedatt--items--options--request_limiter"></a>
### Nested Schema for `items.options.request_limiter`
