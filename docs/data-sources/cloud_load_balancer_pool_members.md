...
page_title: "gcore_cloud_load_balancer_pool_members Data Source - Gcore"
subcategory: ""
description: |-
  Pool members represent backend instances that receive load-balanced traffic from a pool.
---

# gcore_cloud_load_balancer_pool_members (Data Source)
...
```terraform
data "gcore_cloud_load_balancer_pool_members" "example_cloud_load_balancer_pool_members" {
  project_id = 1
  region_id = 1
