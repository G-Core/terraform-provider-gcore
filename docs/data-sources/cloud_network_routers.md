...
- `external_gateway_info` (Attributes) State of this router's external gateway. Null when the router has no external gateway. (see [below for nested schema](#nestedatt--items--external_gateway_info))
- `id` (String) Router ID
