...
page_title: "gcore_cloud_lblistener Resource - gcore"
subcategory: ""
description: |-
  
---

# gcore_cloud_lblistener (Resource)
...
```shell
$ terraform import gcore_cloud_lblistener.example '<project_id>/<region_id>/<listener_id>'
```
