...
page_title: "gcore_cdn_cdn_resource_rule Resource - gcore"
subcategory: ""
description: |-
...
# gcore_cdn_cdn_resource_rule (Resource)
...
```shell
$ terraform import gcore_cdn_cdn_resource_rule.example '<resource_id>/<rule_id>'
```
